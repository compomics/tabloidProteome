...
public class VisualisationBean implements Serializable {
    ...
    public void load2() {
        ...
        if (requestParams.containsKey("view") && requestParams.get("view").equals("graph")) {
            ...
            allAddedElements.setProteins(new ArrayList<>());
            allAddedElements.setLinks(new ArrayList<>());
        }
    }
    ...
    public void changeThreshold() {
        ...
        //@TODO do we need a new instance here???
    ...
    public void removeNodesLinksInJSON(String accession) {
        ...
        allAddedElements.getLinks().removeIf(removedLinks::contains);
        ...
        for (LinkDTO link : removedLinks) {
            ...
            if (!keep) {
                if (allAddedElements.getProteins().stream().anyMatch(p -> p.getUniprotAccession().equals(link.getTarget()))) {
        ...
        accessions.removeIf(removedAccessions::contains);
    ...
    private List<LinkDTO> addNewLinksToRemove(List<LinkDTO> removedLinks) {
        ...
        if (!newLinksToRemove.isEmpty()) {
            ...
            allAddedElements.getLinks().removeIf(newLinksToRemove::contains);
